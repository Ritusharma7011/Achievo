...
//     return (
//     <>
//         <Table className="overflow-hidden rounded-xl border border-white/10 bg-btn-secondary">
//         <Thead>
//             <Tr
//             className="
//                 hidden
...
//             "
//             >
//             <Th className="flex-1 text-left text-xs font-semibold uppercase tracking-wider text-gray-400">
//                 Course
//             </Th>

//             <Th className="w-[120px] text-left text-xs font-semibold uppercase tracking-wider text-gray-400">
//                 Price
//             </Th>
...
//                     Start creating your first course on Achievo.
//                     </p>
//                 </div>
//                 </Td>
//             </Tr>
...
//                 >
//                 {/* COURSE INFO */}
//                 <Td colSpan={1} className="flex flex-1 flex-col gap-4 lg:flex-row">
//                     <img
...
//                         "
//                         >
//                         <div className="flex h-4 w-4 items-center justify-center rounded-full bg-green-400 text-black">
//                             <FaCheck size={8} />
//                         </div>
//                         Published
//                         </div>
...
//                 {/* DESKTOP DURATION */}
//                 {/* <Td className="hidden w-[140px] text-sm font-medium text-gray-300 lg:block">
//                     {course?.courseContent?.reduce((acc, sec) => {
//                     sec?.subsection?.forEach((sub) => {
//                         console.log("TIME DURATION:", sub?.timeDuration)
//                         acc += parseFloat(sub?.timeDuration) || 0
//                     })
...
//                 {/* DESKTOP PRICE */}
//                 <Td className="hidden w-[120px] text-sm font-semibold text-white lg:block">
//                     ₹{course.price}
//                 </Td>

//                 {/* ACTIONS */}
//                 <Td className="w-full lg:w-[120px]">
